...
;
.data BSS
.space byte 1			; byte send/received
.space parity 1			; parity holder for rx
.space special 1		; ctrl, shift, caps and kb LED holder 
.space lastbyte 1		; last byte received
