...
;  2014/02/04	RAC	Revectored NMI vector to handler in nmi.asm
...
Nextvec1       
		...
		CMP   NMIvector+2      
		beq   nextvec2
;*****  If using the programmer's PANIC button connected
;	to VIA1.CA1, then set the handler to NMIVEC in
;	nmi.asm instead of the default RTI.
...
;		jsr	InitDisp	; init the external video board
		jsr	VInitDisp	; init the internal video controller
